...
static char *openurl[] = { "/bin/sh", "-c", "url -o", "externalpipe", NULL };
static char *copyurl[] = { "/bin/sh", "-c", "url -c", "externalpipe", NULL };
static char *copyout[] = { "/bin/sh", "-c", "copyout", "externalpipe", NULL };
